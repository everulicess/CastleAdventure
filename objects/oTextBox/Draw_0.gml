accept_key = keyboard_check_pressed(vk_space); textbox_x = camera_get_view_x(view_camera[0]); textbox_y = camera_get_view_y(view_camera[0]) + 90;
//................setup....................
if (setup == false)
{
	setup = true;
		...
		for (var c= 0; c < text_length[p]; c++)
		{
			...
			for (var lb = 0; lb< line_break_num[p]; lb++)
			{
				...
				if _char_pos >= line_break_pos[lb, p]
				{
					...
					//recors the "line" this character should be on
					_txt_line = lb+1
				}
			}
...
if draw_char == text_length[page] && page == page_number-1
{
	...
	for (var op = 0; op < option_number; op++ )
	{
		...
		if option_pos == op
		{
			draw_sprite(sTextBoxArrow, 0, _txtb_x, _txtb_y - _op_space*option_number + _op_space*op)
		}
		//the option text
		//draw_text(_txtb_x + 16 +_op_bord, _txtb_y -_op_space*option_number + _op_space* op + 2, option[op]);
		draw_text_color(_txtb_x + 16 +_op_bord, _txtb_y -_op_space*option_number + _op_space* op + 2, option[op],c_black, c_black,c_black,c_black,1);
	}	
}
//........draw the text..........
